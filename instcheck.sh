...
wget -qO- https://raw.githubusercontent.com/Stalkermtx/Checkuser2024/main/chall.sh -O /bin/chall > /dev/null 2>&1
wget -qO- https://raw.githubusercontent.com/Stalkermtx/Checkuser2024/main/checkgestor.sh -O /bin/checkgestor > /dev/null 2>&1
wget -qO- https://raw.githubusercontent.com/Stalkermtx/Checkuser2024/main/checkgestor.py -O /usr/lib/checkgestor/checkgestor.py > /dev/null 2>&1
...
echo ""
echo -e "\033[1;33m MAIS INFORMAÇÕES \033[1;31m(\033[1;36mTELEGRAM\033[1;31m): \033[1;37m@StartNetOfc\033[0m"
echo ""
